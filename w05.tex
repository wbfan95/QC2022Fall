...
那么对于波函数的导数
\begin{align}
    \pdv{\phi(x,y)}{x} = \cos\theta \pdv{\phi(r,\theta)}{r} - \frac{\sin\theta} r \pdv{\phi(r,\theta)}{\theta}, 
\end{align}
所以直接可给出
\begin{align}
...
再做二次偏导
\begin{align}
    \pdv[2]{\phi(x,y)}{x} = \pdv{x} \left(\cos\theta \frac{\phi}r - \frac{\sin\theta}r \pdv{\phi}{\theta}\right)
    \label{eq:polar_2nd_derv}
\end{align}
其中第一项
\begin{align}
    \pdv{x} \left(\cos\theta\pdv{\phi}{r}\right) 
    &= \pdv{\cos\theta}{x}\pdv{\phi}{r} + \cos\theta \pdv{x} \pdv{\phi}{r} \\
    &=\frac{\sin^2\theta}{r} \pdv{\phi}{r} + \cos\theta \left(\pdv[2]{\phi}{r} \pdv{r}{x} + \pdv[2]{\phi}{r}{\theta} \pdv{\theta}{x}\right) \\
    & = \frac{\sin^2\theta}{r} \pdv{\phi}{r} + \cos\theta \left( \cos\theta \pdv[2]{\phi}{r} - \frac{\sin\theta}{r} \pdv[2]{\phi}{r}{\theta}\right)
\end{align}
利用了
\begin{align}
...
第二项
\begin{align}
    \pdv{x} \left(\frac{\sin\theta}{r}\pdv{\phi}{x}\right) 
    &= - \frac{2\sin\theta \cos\theta}{r^2} \pdv{\phi}{\theta} + \frac{\sin\theta}r \left(\pdv[2]{\phi}{r}{\theta} \pdv{r}{x} + \pdv[2]{\phi}{\theta} \pdv{\theta}{x}\right)\\
    &=- \frac{2\sin\theta\cos\theta}{r^2} \pdv{\phi}{\theta} + \frac{\sin\theta \cos\theta}{r} \pdv[2]{\phi}{r}{\theta} - \frac{\sin^2\theta}{r^2} \pdv[2]{\phi}{\theta},
\end{align}
利用了
\begin{align}
...
\begin{lstlisting}
(* 对 x 的二阶偏导，输出略 *)
D[\[Phi][Sqrt[x^2 + y^2], ArcCos[x/Sqrt[x^2 + y^2]]], {x, 2}];
Simplify[%, 
...
\begin{align}
    \pdv[2]{\phi(x,y)}{x}     
    &= \pdv{x} 
    \left(\cos\theta \pdv{\phi}{r} - \frac{\sin\theta}{r} \pdv{\phi}{\theta}\right) \\
    &= \cos^2\theta \pdv[2]{\phi}{r} - \frac{2\sin\theta\cos\theta}{r} \pdv[2]{\phi}{r}{\theta} + \frac{\sin^2\theta}{r^2} \pdv[2]{\phi}{\theta} \notag \\
    &\phantom{=} \quad + \frac{\sin^2\theta}{r} \pdv[2]{\phi}{r} + \frac{2\sin\theta\cos\theta}{r^2} \pdv{\phi}{\theta},
\end{align}
同理
\begin{align}
    \pdv[2]{\phi(x,y)}{y} &= \sin^2\!\theta \pdv[2]{\phi}{r} + \frac{2\sin\theta \cos\theta}{r} \pdv[2]{\phi}{r}{\theta} + \frac{\cos^2\theta}{r^2} \pdv[2]{\phi}{\theta} \notag\\
    &\phantom{=}\quad+ \frac{\cos^2\theta}{r} \pdv{\phi}{r} - \frac{2\sin\theta \cos\theta}{r^2} \pdv{\phi}{\theta}, 
\end{align}
于是 \eqref{eq:polar_2nd_derv} 为
\begin{align}
    \pdv[2]{\phi}{x} + \pdv[2]{\phi}{y} &= \pdv[2]{\phi}{r} + \frac1{r^2} \pdv[2]{\phi}{\theta} + \frac1r \pdv{\phi}{r} \\
    &=\pdv[2]{\phi}{r} + \frac1r \pdv{\phi}{r} + \frac1{r^2}\pdv[2]{\phi}{\theta}, 
\end{align}

最终哈密顿量写为
\begin{align}
    \hat H = - \frac{\hbar^2}{2m} \left(\pdv[2]{x} + \pdv[2]{y}\right) = -\frac{\hbar^2}{2m} \left(\pdv[2]{\phi}{r} + \frac1r \pdv{\phi}{r} + \frac1{r^2}\pdv[2]{\phi}{\theta}\right),
\end{align}
...
薛定谔方程为
\begin{align}
    \hat H \phi(\theta) &= E\phi(\theta)\\
    - \frac{\hbar^2}{2I} \pdv[2]{\phi}{\theta} &= E\phi
\end{align}
整理得到
\begin{align}
    \pdv[2]{\phi(\theta)}{\theta} + M^2 \phi(\theta) = 0, \quad M^2 = \frac{2IE}{\hbar^2},
\end{align}
这是个二阶微分方程，设 $\phi(\theta) = \ee^{s\theta}$，有
\begin{align}
...
可得方程通解
\begin{align}
    \phi(\theta) = A \ee^{\ii M\theta} + B \ee^{-\ii M \theta}
\end{align}
共有三个待求变量 $\{A, B, M\}$。
...
\begin{align}
    M^2 = \frac{2IE}{\hbar^2} \Rightarrow E = \frac{M^2\hbar^2} {2I} = \frac{m^2\hbar^2} {8\pi^2 L},
\end{align}
...
角动量算符作用到通解波函数上，
\begin{align}
    \hat L_z \phi(\theta) \overset{?}{=} C\phi(\theta),
\end{align}
...
环运动的通解是两个本征函数的线性组合，包含了顺时针和逆时针旋转的组合。哈密顿算符和 $\hat l_z$ 是队医的，可以构造同时属于二者的本征函数完备集，所以可以把 $\phi(\theta)$ 写成 $A \ee^{\ii m \phi}$ 的形式。

接上午的求解。由归一化确定 $A$，
\begin{align}
    \int_0^{2\pi} \phi^*(\theta) \phi(\theta) \dd\theta = A^2 \int_{0}^{2\pi} \dd\theta = 2\pi A^2 = 1,
\end{align}
解之得
\begin{align}
    \phi(\theta) = \frac{1}{\sqrt{2\pi}} \ee^{\ii m \theta}, \quad \rho(\theta) = |\phi(\theta)|^2 = \frac1{2\pi},
\end{align}
...
\begin{align}
    \hat H = -\frac{\hbar^2}{2m} \left(\pdv[2]{x} + \pdv[2]{y} + \pdv[2]{z}\right), \quad \hat H \phi(x,y,z) = E \phi (x,y,z),
\end{align}
...
其中
\begin{align}
    \Omega = \left\{(x,y,z) \, |\,  x^2+y^2 \leq R^2, 0\leq z\leq l\right\}. 
\end{align}
